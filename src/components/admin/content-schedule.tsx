...
const SCHEDULE: DaySchedule[] = [
  ...
  { day: "Quinta-feira",  short: "Qui", type: "reels",    label: "Reels",            description: "Vídeo curto. Foco em dor, dado ou comparativo." },
  { day: "Sexta-feira",   short: "Sex", type: "off",      label: "Descanso",         description: "Sem post hoje." },
