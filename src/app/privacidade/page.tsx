      ...
      <div className="mx-auto max-w-3xl px-5 py-12 space-y-10">
        ...
        <div className="space-y-8 text-foreground">
          ...
          <Section title="9. Transferência Internacional">
            <p>Alguns de nossos fornecedores (Stripe, Supabase, Vercel, Groq) operam fora do Brasil. Essas transferências ocorrem com base em cláusulas contratuais padrão e garantias equivalentes às exigidas pela LGPD (art. 33).</p>
          </Section>
