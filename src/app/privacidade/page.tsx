      ...
      <div className="mx-auto max-w-3xl px-5 py-12 space-y-10">
        ...
        <div className="space-y-8 text-foreground">
          ...
          <Section title="7. Seus Direitos (LGPD)">
            ...
            <p>Para exercer qualquer direito, envie um e-mail para <strong>contato@zeta.com.br</strong> com o assunto "Direitos LGPD". Responderemos em até 15 dias úteis.</p>
          </Section>
          ...
          <Section title="11. Contato">
            ...
            <ul>
              <li>E-mail: <strong>contato@zeta.com.br</strong></li>
